...
def run_suite(gen_all_holds):
    ...
    hand = tuple([4, 2])
    suite.run_test(gen_all_holds(hand), {(), (4,), (2,), (4, 2)}, "Test #2:")

    hand = tuple((1, 2, 2))
    suite.run_test(gen_all_holds(hand), {(), (1,), (2,), (1, 2), (2, 2), (1, 2, 2)}, "Test #3:")

    hand = tuple((2, 1, 2))
    suite.run_test(gen_all_holds(hand), {(), (1,), (2,), (1, 2), (2, 1), (2, 2), (2, 1, 2)}, "Test #4:")

    hand = tuple([6, 2, 3])
    suite.run_test(gen_all_holds(hand), {(), (6,), (2,), (6, 2), (3,), (6, 3), (2, 3), (6, 2, 3)}, "Test #5:")
